                  ...
                  <table className="table card-table table-vcenter text-nowrap datatable">
                    <thead>
                      <tr>
                        ...
                        <th>
                          <a className="sort-item" data-sort="sender.nickName">
                            닉네임
                          </a>
                        </th>
                        <th>
                    ...
                    <tbody>
                      ...
                      >
                        <td colSpan="6">
                          <div style={{ padding: "20px" }}>
                            <h3>0225 테스트1</h3>
                            <div style={{ marginbottom: "10px" }}>테스트 1</div>
                            <a href="" target="_blank"></a>
                          </div>
                      ...
                      >
                        <td colSpan="6">
                          <div style={{ padding: "20px" }}>
                            <h3>test1</h3>
                            <div style={{ marginbottom: "10px" }}>test111</div>
                            <a
                      ...
                      >
                        <td colSpan="6">
                          <div style={{ padding: "20px" }}>
                            <h3>111111</h3>
                            <div style={{ marginbottom: "10px" }}>rewrewr</div>
                            <a href="" target="_blank"></a>
                          </div>
