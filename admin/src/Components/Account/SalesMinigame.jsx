          ...
          <div className="page-header d-print-none">
            <div className="row align-items-center">
              <div className="col">
                ...
                <h2 className="page-title">매출현황(미니게임)</h2>
              </div>
                      ...
                      <tbody>
                        <tr>
                          <td className="text-center">
                            ...
                            <span className="text-dark">화</span>)
                          </td>
                          <td className="text-right">
                            <div className="text-primary">35</div>
                            <div className="text-danger">30</div>
                          </td>
                          <td className="text-right">
                        ...
                        <tr>
                          ...
                          <td className="text-right">
                            ...
                            <div className="text-danger">146</div>
                          </td>
                          <td className="text-right">
                        ...
                        <tr>
                          ...
                          <td className="text-right">
                            <div className="text-primary">865</div>
                            <div className="text-danger">809</div>
                          </td>
                          <td className="text-right">
                            <div className="text-primary">0</div>
                            <div className="text-danger">0</div>
                          ...
                          <td className="text-right">
                            <div className="text-primary">315</div>
