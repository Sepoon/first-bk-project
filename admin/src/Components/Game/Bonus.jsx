                ...
                <div className="row align-items-center">
                    ...
                    <div className="col-auto ms-auto d-print-none">
                        ...
                        <span className="d-none d-sm-inline">
                            <a href="#" className="btn btn-primary" id="create-bonus-btn">
                                추가하기
                            </a>
                        </span>
                        </div>
...
{ /* <!--                                        <td><input className="form-check-input m-0 align-middle" type="checkbox" aria-label="Select"></td>--> */ }
                                        ...
                                        <td className="text-center">
                                            <a href="#" className="btn btn-white edit-btn" data-id="-1" data-price="1.030" data-name="3폴더 이상" data-baseline="3">수정</a>
                                            <a href="#" className="btn btn-outline-secondary delete-btn" data-id="-1">
                                                삭제하기
                                            </a>
...
{ /* <!--                                        <td><input className="form-check-input m-0 align-middle" type="checkbox" aria-label="Select"></td>--> */ }
                                        ...
                                        <td className="text-center">
                                            <a href="#" className="btn btn-white edit-btn" data-id="-2" data-price="1.060" data-name="6폴더 이상" data-baseline="6">수정</a>
                                            <a href="#" className="btn btn-outline-secondary delete-btn" data-id="-2">
                                                삭제하기
                                            </a>
...
{ /* <!--                                        <td><input className="form-check-input m-0 align-middle" type="checkbox" aria-label="Select"></td>--> */ }
                                        ...
                                        <td className="text-center">
                                            <a href="#" className="btn btn-white edit-btn" data-id="-3" data-price="1.090" data-name="9폴더 이상" data-baseline="9">수정</a>
                                            <a href="#" className="btn btn-outline-secondary delete-btn" data-id="-3">
                                                삭제하기
                                            </a>
...
{ /* <!--                            </div>--> */ }
        ...
        <div className="modal modal-blur fade" id="bonus-modal" tabIndex="-1" role="dialog" aria-hidden="true">
                ...
                <div className="modal-content">
                    ...
                    <div className="modal-body">
                        <div className="row">
                            <div className="col-lg-6">
                                <div className="form-group mb-1 row">
                                    <label className="form-label col-4 col-form-label">제목</label>
                                    <div className="col">
                                        <input type="text" className="form-control" aria-describedby=""
                                               placeholder="아이디" defaultValue="" name="name" id="bonus-name"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="row">
                            <div className="col-lg-6">
                                ...
                                <div className="form-group mb-1 row">
                                    <label className="form-label col-4 col-form-label">폴더수</label>
                                    <div className="col">
                                        <input type="text" className="form-control" aria-describedby=""
                                               placeholder="폴더수" defaultValue="" name="baseline" id="bonus-baseline"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="row">
                            <div className="col-lg-6">
                                <div className="form-group mb-1 row">
                                    <label className="form-label col-4 col-form-label">배당</label>
                                    <div className="col">
                                        <input type="number" className="form-control" aria-describedby=""
                                               placeholder="배당" defaultValue="" name="price" id="bonus-price" step=".01"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="modal-footer">
                        ...
                        <div className="ms-auto">
                            ...
                            <a href="#" className="btn btn-primary edit-submit-btn" data-bs-dismiss="modal">
                                수정하기
                            </a>
                        </div>
                    </div>
